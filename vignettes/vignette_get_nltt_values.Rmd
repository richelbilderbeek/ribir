...
```{r}
qplot(t, nltt, data = df, geom = "point", ylim = c(0,1), main = "nLTT plot of phylogenies", color = id, size = I(0.1)) + geom_smooth(span = 0.1)
```
...
GOOD: shows original lines and confidence interval:
