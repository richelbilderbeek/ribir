---
title: "How to get the average nLTT plot,  new"
author: "Richel Bilderbeek"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to get the average nLTT plot, new}
...
```{r}
df <- as.data.frame(ribir::get_average_nltt_matrix_impl_3(c(phylogeny1,phylogeny2), dt = 0.01))
names(df) <- c("time","N")

# Bad smoother, but does look nice
qplot(time, N, data = df, geom = "point", ylim = c(0,1), main = "nLTT plot of phylogenies") + geom_smooth(span = 0.1)

# Shows the mean as intended, without confidence interval
qplot(time, N, data = df, geom = "point", ylim = c(0,1), main = "Average nLTT plot of phylogenies") + 
...
qplot(time, N, data = df, geom = "blank", ylim = c(0,1), main = "Average nLTT plot of phylogenies") + 
  stat_summary(fun.data = "mean_cl_boot", color = "red", geom = "smooth")
