---
title: "vignette_stretch_nltt_matrix"
author: "Richel Bilderbeek"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
#output: pdf_document
vignette: >
  %\VignetteIndexEntry{vignette_stretch_nltt_matrix}
...
```{r}
nltt <- ribir::get_phylogeny_nltt_matrix(phylogeny)
stretch_matrix <- ribir::stretch_nltt_matrix(nltt,dt = 0.25, step_type = "upper")
...
nltt <- ribir::get_phylogeny_nltt_matrix(phylogeny)
nLTT.plot(phylogeny)
stretch_matrix <- ribir::stretch_nltt_matrix(nltt,dt = 0.05, step_type = "upper")
points(nltt, pch = 19,col="red")
points(stretch_matrix, pch = 19,col="blue")
```
